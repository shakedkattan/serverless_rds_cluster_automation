...
```
* Private note - I wanted to cost-optimize the lambda function even more using layers, editing resource usage configuration like Memory and more. but couldn't reach it on time. also, there's no auto-cleanup script so if you deploy be careful.
